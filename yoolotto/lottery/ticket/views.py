...
def send_data_to_det(success,ticket,play,game_type,image_data,state,old_version,data):
	...
	RetailerNo = ''
        try:
      	...
      	if state == 'TX' and old_version == False:
            ocr_lib = cdll.LoadLibrary("/home/ubuntu/yoolotto_backend/yoolotto/yoolotto/OCR-OCR_server/YoolottoOCR/libOCR.so") # pass the path of .so file
            ...
            lib_prt_path ="/home/ubuntu/yoolotto_backend/yoolotto/yoolotto/OCR-OCR_server"
	...
	url="http://172.16.2.132:8733/Design_Time_Addresses/DataEntryTool.WcfService/TicketService/AddTicket"
